              ...
              child: Column(
                ...
                children: [
                  Wrap(
                    ...
                    children: const [
                      _Chip(label: 'Main Campus', icon: Icons.location_on_outlined),
                      _Chip(label: 'Academic', icon: Icons.school_outlined),
                    ],
                  ),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Text('Student Career Center', style: AppTextStyles.title),
                    ],
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  _InfoRow(icon: Icons.email_outlined, text: 'career-center@university.edu'),
                  const SizedBox(height: AppSpacing.xs),
                  _InfoRow(icon: Icons.verified_outlined, text: 'Host: University Services'),
                  const SizedBox(height: AppSpacing.xs),
                  GestureDetector(
                    onTap: () => setState(() => _reminderSet = !_reminderSet),
                    child: Row(
                      children: [
                        Icon(
                        ...
                        Text(
                          _reminderSet ? 'Reminder set: 30 mins before' : 'Remind me: 30 mins before',
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: AppSpacing.sm),
                      const Text('Grand Ballroom, Student Union', style: AppTextStyles.title),
                    ],
                  ),
                  const SizedBox(height: AppSpacing.sm),
                  _InfoRow(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: const [
                            Icon(Icons.list_alt_outlined, color: AppColors.logisticsNavy, size: 20),
                          ...
                          (item) => Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: Text(item.$2, style: AppTextStyles.bodyMuted),
                                ),
                              ],
                            ),
                          ),
          ...
          children: [
            Expanded(
              child: OutlinedButton.icon(
                ...
                icon: Icon(
                  _reminderSet ? Icons.notifications_active_outlined : Icons.notifications_outlined,
                  size: 18,
                ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, size: 12, color: AppColors.logisticsNavy),
